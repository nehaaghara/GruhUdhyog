<%-- 
    Document   : Login
    Created on : Mar 5, 2019, 12:20:12 PM
    Author     : ITMCS
--%>
            ...
            <div class="col-lg-6 col-md-8 col-sm-8 col-lg-offset-3 col-sm-offset-2">
              <form class="main-form full" action = "/" method="post">
                <div class="row">
                  ...
                  <div class="col-xs-12">
                    <div class="new-account align-center mt-20"> <span>New to Eshoper?</span> <a class="link" title="Register with Eshoper" href="register.html">Create New Account</a> </div>
                  </div>
                </div>
              </form>
            </div>
